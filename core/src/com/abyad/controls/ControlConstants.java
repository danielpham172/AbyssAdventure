...
public class ControlConstants {
	...
	static {
		...
		DEFAULT_KEYBOARD_CONTROLS.put("RIGHT", new KeyControl(Input.Keys.LEFT,0));
		DEFAULT_KEYBOARD_CONTROLS.put("LEFT", new KeyControl(Input.Keys.RIGHT,0));
		DEFAULT_KEYBOARD_CONTROLS.put("ATTACK", new KeyControl(Input.Keys.A,0));
