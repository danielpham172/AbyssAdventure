...
public class ReviveStatue extends Actor implements Interactable{
	...
	static {
		...
		descText.setText(font, "REVIVE A PLAYER FOR " + GOLD_COST + " GOLD!");
	...
	public void draw(Batch batch, float a) {
		if (floor.inView()) {
			...
			if (isInteractable) {
				...
				float fontY = floor.getCenter().y + (AbstractTile.TILE_LENGTH * 1.5f) - (descText.height / 2);
